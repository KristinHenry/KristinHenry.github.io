...
function drawZipSearch(targ){
  ...
  var form = d3.select(targ).append("div").attr("id", "zipDiv")
  ...
  form.append("div").attr("id", "zipDiv")
      .attr("width", width + margin.left + margin.right)
      .attr("height", 200)
      .append("p").attr("id", "zipData")//.text("Testing testing testing")
  ...
  //   .attr("height", height + margin.top + margin.bottom)
  //   .style("background-color", "#333333")
  //   .append("g")//.attr('id', 'zipSearchData')
  //   .append("p").text('testing')
  //   .attr("transform", "translate(" + margin.left + "," + margin.top + ")");
...
function drawZipSearchData(zip, data, targ, mapInfo, map){
  ...
  // var lastOne = document.getElementById("zipSearchData");
  ...
  // var results = d3.select(targ).append("div")
  // .attr("width", width + margin.left + margin.right)
  //   .attr("height", height + margin.top + margin.bottom)
  //   .style("background-color", "#333333")
  //   .append("g")//.attr('id', 'zipSearchData')
  ...
  map.flyTo(mapInfo)
  map.once('moveend', moveEndFunction)


  // map.once('moveend', function(move){
  //   console.log("testing testing testing move end")

  //   moveEndFunction();

  // })

  // d3.select('#zipData').text("testing again")


}

function moveEndFunction(){

  console.log("testing move end event",zipSearchData)

  // d3.select('#zipData').text(zipSearchData + "  testing")

  // d3.select('#zipDiv').append('p').text('Second p tag')
  ...
  //if(x == null){ 
    console.log('try getting elem')
    var info = document.createElement("p"); 
    info.innerHTML = "Passes through: " + zipSearchData[0] + ", " + zipSearchData[1]
    info.id = 'info' 
